...
let lancerDemandee = document.querySelector('.lancer')
...
function StarAndStopGame(){
    if(lancerDemandee.value!=0 && lancerDemandee.value<=9 ){
        if(pseudo.value!=""){
...
function startGame(){
    function lancer(){
        afficherManche.innerHTML=`<br><p>${lancerDemandee.value} restante</p>
            `
